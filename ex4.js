...
console.log(`O valor de R$ ${real} convertido para Euro fica em ${(real/6.10).toFixed(2)}`);
alert(`O valor de R$ ${real} convertido para Dólar fica em ${(real/5.70).toFixed(2)}`);
console.log(`O valor de R$ ${real} convertido para Dólar fica em ${(real/5.70).toFixed(2)}`);